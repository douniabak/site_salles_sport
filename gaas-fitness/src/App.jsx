...
const gyms=[['GaaS Partner Montréal Centre-ville','Montréal, QC','0,6 km','Faible',['Cardio','Musculation','Poids libres','Cours collectifs'],['Local','Plus','Global']],['Studio Fit Laval','Laval, QC','12,4 km','Modéré',['Cardio','Machines guidées','Cours collectifs','Mobilité'],['Local','Plus','Global']],['Urban Wellness Québec','Québec, QC','18,7 km','Élevé',['Musculation','Sauna','Coach privé','Récupération'],['Plus','Global']],['Fit Network Toronto','Toronto, ON','3,1 km','Faible',['Cardio','Musculation','Cours en direct','Fonctionnel'],['Global']],['Global Gym Paris','Paris, France','1,8 km','Modéré',['Cardio','Poids libres','Machines guidées','Salle premium'],['Global']]];
